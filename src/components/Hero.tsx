...
export const Hero = () => {
  return (
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-[24px] relative overflow-clip">
      ...
      <div className="container relative">
        ...
        <p className="text-center text-xl mt-8 max-w-md">
          This is my first motion and animation landing page its been 11:30pm right now in durg and iam listning to 'scared to be lonely' by Martin Garrix
        </p>
        </div>
        <div className="flex justify-center mt-8">
